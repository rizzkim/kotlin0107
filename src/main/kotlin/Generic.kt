...
//T로 만들어진 프로퍼티에 Super 또는 Super의 하위 클래스 타입의 인스턴스를
//대입할 수 있습니다. - 공변성(covariance)
class MyClass2<out T:Super>{
}

//T로 만들어진 프로퍼티에 Sub 또는 Sub의 상위 클래스 타입의 인스턴스를
//대입할 수 있습니다. - 반공변성(contravariance)
class MyClass3<in T:Sub>{
}
fun main(){
    //MyClass의 인스턴스를 생성
    ...
    //var obj30:MyClass1<Super> = MyClass1<Sub>()
